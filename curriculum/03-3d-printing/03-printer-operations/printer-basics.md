...
![FDM process diagram: 1 – Extruder/nozzle depositing material, 2 – Part being built up layer by layer, 3 – Movable build platform](https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/FDM_printing_diagram.svg/500px-FDM_printing_diagram.svg.png)
*FDM process: the extruder/nozzle (1) deposits melted filament, building up the part (2) layer by layer on a movable platform (3). Each layer is 0.1–0.3 mm thick. Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:FDM_printing_diagram.svg), CC BY-SA 4.0*
...
*[← Section Index](./README.md) | [🏠 Curriculum Index](../../README.md) | [Next: Operations →](./operations.md)*
