...
![FDM desktop 3D printer in operation — showing the aluminum extrusion frame, gantry, print head, and build platform](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/3D_printer2.jpg/400px-3D_printer2.jpg)
*An FDM printer in operation — note the aluminum extrusion frame, gantry motion system, print head, and heated build plate. This module covers every mechanical system visible here. Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:3D_printer2.jpg), CC BY-SA 3.0*
...
![3D printer extruder cross-section showing the stepper motor (top) that drives precise linear motion — the same motor type drives X, Y, Z axes on rails and rods](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/3D_Printer_Extruder.svg/400px-3D_Printer_Extruder.svg.png)
*The stepper motor (top of diagram) provides rotational motion which is converted to precise linear movement via belts and rails. LM8UU rod bearings and MGN12H linear rails guide this motion with minimal friction. Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:3D_Printer_Extruder.svg), CC BY-SA 4.0*
...
![3D printer hotend cross-section showing heat break, heater block with cartridge and thermistor, and nozzle — filament path from cold to hot zone](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/3D_Printer_Extruder.svg/400px-3D_Printer_Extruder.svg.png)
*Hotend cross-section: filament (top) enters the cold zone, passes through the heat break (thermal isolation), melts in the heater block, and exits the nozzle (bottom). The thermistor and heater cartridge are embedded in the heater block. Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:3D_Printer_Extruder.svg), CC BY-SA 4.0*
...
*[← Electronics Basics](../01-electronics-basics/README.md) | [Section Index](./README.md) | [🏠 Curriculum Index](../README.md) | [Next: 3D Printing →](../03-3d-printing/README.md)*
